...
let points = JSON.parse(fs.readFileSync('./fkk1/fkkPTS.json', 'utf8'));
...
message.channel.send('**لديك 15 ثانية للجابة**').then(msg => {
	let embed = new Discord.RichEmbed()
	.setColor('#000000')
	.setFooter("فكك | لرؤية مجموع نقاطك اكتب $نقاطي")
	...
	msg.channel.sendEmbed(embed).then(() => {
		...
		console.log(`[Typing] ${collected.first().author} typed the word.`);
            let won = collected.first().author; // في هذا السطر يقوم الكود بسحب ��لأي دي الذي قام بالأجابة اولاً
...
var Eror = new Discord.RichEmbed()
   ...
   .setTimestamp()
   .setDescription(`شكراً على �طلبك !`)
.addField(`طلبك : `, a8tra7)
   var Sure = new Discord.RichEmbed()
   .setTimestamp()
   .setDescription(`هل انت متأكد من ارسال الطلب؟ معك دقيقه قبل الالغاء`)
...
No.on("collect", r => {
message.channel.send('تم الغاء طلبك بنجاح :white_check_mark: ').then(message => {message.delete(2000)})
msg.delete();
})
})
}
